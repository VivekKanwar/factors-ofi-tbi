...
underscoring the need for TBI-specific quality improvement efforts [@Szolnoky2025]. Therefore, we
hypothesise that despite existing trauma quality improvement measures, new OFIs can be identified in
the care of adult trauma patients with TBI.

Aim
=====
As such, this study aims to determine whether OFIs occur in the care of adult trauma patients with
TBI, and, if so, to quantify their frequency, describe their characteristics, and examine whether
patient- and process-related factors are associated with their occurrence.
...
Scale (GCS) score of ≤8 combined with an Abbreviated Injury Scale (AIS) severity ≥3 for the head region.
Patients were eligible irrespective of level of care and were not restricted to intensive care admissions.
